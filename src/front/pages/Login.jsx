...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Guardar usuario y token en localStorage con loggedIn
            localStorage.setItem(
                "user",
                JSON.stringify({ email, token: data.token, loggedIn: true })
            );

            // Actualizar estado global si tienes reducer
            dispatch({ type: "login" });
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-white :bg-gray-950 px-4">
